...
GRANT SELECT ON ZOEARCHIVE.ZEMR_TEMPERATURE_POINT_RECORD_A     TO ZEMR;
GRANT SELECT ON ZOEARCHIVE.ZEMR_TEMPERATURE_FEVER_A            TO ZEMR;
GRANT SELECT ON ZOEARCHIVE.ZEMR_TEMPERATURE_ENTIRE_RECORD_A    TO ZEMR;
...
ALTER TABLE  ZEMR.ZEMR_TEMPERATURE_POINT_RECORD     RENAME TO ZEMR_TEMPERATURE_POINT_RECORD_O;
ALTER TABLE  ZEMR.ZEMR_TEMPERATURE_FEVER            RENAME TO ZEMR_TEMPERATURE_FEVER_O;
ALTER TABLE  ZEMR.ZEMR_TEMPERATURE_ENTIRE_RECORD    RENAME TO ZEMR_TEMPERATURE_ENTIRE_RECORD_O;
...
CREATE OR REPLACE VIEW ZEMR.ZEMR_TEMPERATURE_POINT_RECORD   AS SELECT * FROM ZOEARCHIVE.ZEMR_TEMPERATURE_POINT_RECORD_A   UNION ALL SELECT * FROM ZEMR_TEMPERATURE_POINT_RECORD_O   WITH READ ONLY;
...
CREATE OR REPLACE VIEW ZEMR.ZEMR_TEMPERATURE_ENTIRE_RECORD  AS SELECT * FROM ZOEARCHIVE.ZEMR_TEMPERATURE_ENTIRE_RECORD_A  UNION ALL SELECT * FROM ZEMR_TEMPERATURE_ENTIRE_RECORD_O  WITH READ ONLY;
...
GRANT SELECT ON ZEMR.ZEMR_TEMPERATURE_POINT_RECORD_O     TO ZOEARCHIVE;
GRANT SELECT ON ZEMR.ZEMR_TEMPERATURE_FEVER_O            TO ZOEARCHIVE;
GRANT SELECT ON ZEMR.ZEMR_TEMPERATURE_ENTIRE_RECORD_O    TO ZOEARCHIVE;
