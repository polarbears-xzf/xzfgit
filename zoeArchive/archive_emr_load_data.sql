...
Insert into ZOEARCHIVE.ARC_PROCESS_TASK_CONFIG (TASK_ID,TABLE_OWNER,TABLE_NAME,ARCHIVE_TABLE_OWNER,ARCHIVE_TABLE_NAME,DETAIL_TABLE_FLAG,RELATE_MASTER_TABLE_NAME,RELATE_MASTER_TABLE_COLUMN,RELATE_DETAIL_TABLE_COLUMN,ARCHIVE_DATE_COLUMN,ARCHIVE_CONDITION_C1,ARCHIVE_TABLE_C1,ARCHIVE_CONDITION_C2,ARCHIVE_TABLE_C2,PROCESS_ORDER) values (4,'ZEMR','ZEMR_TEMPERATURE_ENTIRE_RECORD','ZOEARCHIVE','ZEMR_TEMP_ENTIRE_RECORD_A',null,null,null,null,null,'PATIENT_ID','PATIENT_ID','EVENT_NO','EVENT_NO',11);
