...
/*==============================================================*/
/* Table: DVP_CUSTOMER_BASIC_INFO                               */
/*==============================================================*/
CREATE TABLE ZOEDEVOPS.DVP_CUSTOMER_BASIC_INFO 
(
   CUSTOMER_ID          VARCHAR2(64)         DEFAULT SYS_GUID() NOT NULL,
   CUSTOMER_NAME        VARCHAR2(255 CHAR),
   CREATOR_CODE         VARCHAR2(64),
   CREATED_TIME         DATE,
   MODIFIER_CODE        VARCHAR2(64),
   MODIFIED_TIME        DATE,
   CONSTRAINT PK_DVP_CUSTOMER_BASIC_INFO PRIMARY KEY (CUSTOMER_ID)
);

COMMENT ON TABLE ZOEDEVOPS.DVP_CUSTOMER_BASIC_INFO IS
'客户基本信息';

COMMENT ON COLUMN ZOEDEVOPS.DVP_CUSTOMER_BASIC_INFO.CUSTOMER_ID IS
'客户ID';

COMMENT ON COLUMN ZOEDEVOPS.DVP_CUSTOMER_BASIC_INFO.CUSTOMER_NAME IS
'客户名称';

COMMENT ON COLUMN ZOEDEVOPS.DVP_CUSTOMER_BASIC_INFO.CREATOR_CODE IS
'创建人';

COMMENT ON COLUMN ZOEDEVOPS.DVP_CUSTOMER_BASIC_INFO.CREATED_TIME IS
'创建时间';

COMMENT ON COLUMN ZOEDEVOPS.DVP_CUSTOMER_BASIC_INFO.MODIFIER_CODE IS
'修改人';

COMMENT ON COLUMN ZOEDEVOPS.DVP_CUSTOMER_BASIC_INFO.MODIFIED_TIME IS
'修改时间';
...
(
   ...
   MODIFIER_CODE        VARCHAR2(64),
   MODIFIED_TIME        DATE,
   CONSTRAINT PK_DVP_DB_USER_INFO PRIMARY KEY (DB_ID#)
);
...
COMMENT ON COLUMN ZOEDEVOPS.DVP_DB_BASIC_INFO.CUSTOMER_ID IS
'客户ID';
